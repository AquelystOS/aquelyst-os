...
DEFAULT_CATEGORIES = [
    ...
    _cat("multi-facility horse operation", "Duo Equine", 1, active=True),
    _cat("horse rescue", "Duo Equine", 2, active=True),
    _cat("therapeutic riding nonprofit", "Duo Equine", 1, active=True),
    _cat("equine therapy nonprofit", "Duo Equine", 1, active=True),
    _cat("equine rehabilitation center", "Duo Equine", 1),
    _cat("working equestrian ranch", "Duo Equine", 2),
    _cat("equestrian college program", "Duo Equine", 2),
    ...
    _cat("zoo", "Pets", 1, active=True),
    _cat("aquarium", "Pets", 2),
    _cat("wildlife park", "Pets", 1),
    _cat("petting zoo", "Pets", 3),
    _cat("wildlife rehabilitation center", "Pets", 1, active=True),
    _cat("exotic animal sanctuary", "Pets", 2),
    _cat("primate sanctuary", "Pets", 2),
    _cat("exotic pet breeder", "Pets", 2),
    _cat("reptile breeding facility", "Pets", 2),
    _cat("bird aviary commercial operation", "Pets", 2),
    _cat("aquaculture hatchery", "Pets", 2),
    ...
    _cat("waste management company", "SpillMaster", 1, active=True),
    ...
    _cat("biohazard cleanup company", "SpillMaster", 1, active=True),
    _cat("crime scene cleanup", "SpillMaster", 1, active=True),
    # New gap-fills (Apr 2026 deep-dive — cannabis, municipal infra, transit)
    _cat("cannabis processing facility", "SpillMaster", 1, active=True),
    _cat("cannabis trimming facility", "SpillMaster", 1),
    _cat("cannabis testing lab", "SpillMaster", 2),
    _cat("municipal water treatment plant", "SpillMaster", 1, active=True),
    _cat("municipal wastewater treatment plant", "SpillMaster", 1, active=True),
    _cat("biosolids management facility", "SpillMaster", 2),
    _cat("grain elevator operator", "SpillMaster", 1),
    _cat("pet food manufacturer", "SpillMaster", 1, active=True),
    _cat("airline ground services", "SpillMaster", 2),
    _cat("school bus depot", "SpillMaster", 2),
    _cat("public transit maintenance depot", "SpillMaster", 2),
    _cat("concert hall operator", "SpillMaster", 2),
    _cat("arena maintenance facility", "SpillMaster", 2),
    _cat("medical waste incinerator", "SpillMaster", 2),
    _cat("pharmaceutical lab waste facility", "SpillMaster", 2),
    _cat("food wholesale distributor", "SpillMaster", 2),
    _cat("race track maintenance facility", "SpillMaster", 2),
    ...
    _cat("private aviation hangar operator", "AMR", 1, active=True),
    _cat("private jet operator", "AMR", 2),
    _cat("corporate jet hangar", "AMR", 2),
    _cat("fbo aircraft hangar", "AMR", 2),
    _cat("helicopter charter", "AMR", 3),
    _cat("aircraft maintenance facility", "AMR", 2),
    _cat("luxury car rental fleet", "AMR", 2, active=True),
    _cat("armored vehicle operator", "AMR", 2),
    _cat("funeral hearse fleet operator", "AMR", 1, active=True),
    _cat("corporate shuttle service", "AMR", 2),
    _cat("ride-hailing fleet maintenance", "AMR", 2),
    _cat("waste collection vehicle depot", "AMR", 2),
    _cat("hazmat transport fleet", "AMR", 2),
    _cat("liveaboard marina operator", "AMR", 2),
    ...
    # NEW gap-fills (Apr 2026): emotional-urgency / fastest-close categories
    _cat("hoarder cleanup specialist", "HouseHold", 1, active=True),
    _cat("hoarding disorder cleanup specialist", "HouseHold", 1),
    _cat("biohazard residential cleanup", "HouseHold", 1, active=True),
    _cat("forensic cleaning company", "HouseHold", 1, active=True),
    _cat("crime scene and trauma cleanup", "HouseHold", 1),
    _cat("unattended death cleanup", "HouseHold", 1),
    _cat("disaster recovery contractor", "HouseHold", 1, active=True),
    _cat("flood restoration crew", "HouseHold", 1),
    _cat("insurance restoration network", "HouseHold", 2),
    _cat("cigarette smoke odor removal specialist", "HouseHold", 2),
    _cat("hoarder estate liquidation", "HouseHold", 2),
    _cat("rental property turnover cleaning", "HouseHold", 2),
    _cat("mold remediation company", "HouseHold", 2),
    _cat("water damage restoration", "HouseHold", 2),
    _cat("fire damage restoration", "HouseHold", 2),
    _cat("smoke damage restoration", "HouseHold", 3),
    _cat("sewage cleanup service", "HouseHold", 2),
    ...
    _cat("aquaculture facility", "Inversion Misting", 2),
    _cat("recirculating aquaculture system", "Inversion Misting", 1, active=True),
    _cat("fish farm", "Inversion Misting", 2),
    _cat("commercial mushroom farm", "Inversion Misting", 1, active=True),
    _cat("mushroom cultivation operation", "Inversion Misting", 1),
    _cat("commercial greenhouse", "Inversion Misting", 2),
    _cat("hydroponic greenhouse", "Inversion Misting", 2),
    _cat("hydroponics farm", "Inversion Misting", 2),
    _cat("vertical farming operation", "Inversion Misting", 1, active=True),
    _cat("controlled environment produce farm", "Inversion Misting", 2),
    _cat("microgreens production facility", "Inversion Misting", 2),
    _cat("commercial nursery", "Inversion Misting", 3),
    # Cannabis cultivation — biggest 18-month opportunity, capital-rich,
    # odor-compliance is regulatory, misting is native
    _cat("cannabis cultivation facility", "Inversion Misting", 1, active=True),
    _cat("cannabis flower facility", "Inversion Misting", 1),
    _cat("medicinal cannabis processing facility", "Inversion Misting", 1),
    _cat("cannabis drying room operator", "Inversion Misting", 2),
    _cat("hemp cultivation facility", "Inversion Misting", 2),
    # Specialty / emerging
    _cat("insect protein production", "Inversion Misting", 2),
    _cat("seaweed kelp cultivation", "Inversion Misting", 3),
